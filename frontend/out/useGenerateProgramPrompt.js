...
// src/hooks/useGenerateProgramPrompt.js
var useGenerateProgramPrompt_exports = {};
__export(useGenerateProgramPrompt_exports, {
  generateProgramPromptString: () => generateProgramPromptString
});
module.exports = __toCommonJS(useGenerateProgramPrompt_exports);
...
// src/hooks/useGenerateProgramPrompt.js
var generateProgramPromptString = (userInfo) => {
  if (!userInfo) return null;
  const formattedDate = format(/* @__PURE__ */ new Date(), "yyyy-MM-dd");
